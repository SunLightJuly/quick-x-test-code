    ...
    int       nCmdShow)
{
    ...
    return HelloPlayer::createAndRun();
}

int HelloPlayer::createAndRun(void)
{
    HelloPlayer *host = HelloPlayer::sharedInstance();
    int ret = host->run();
    HelloPlayer::purgeSharedInstance();
    return ret;
}

HelloPlayer *HelloPlayer::s_sharedInstance = NULL;

HelloPlayer *HelloPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new HelloPlayer();
    }
    return s_sharedInstance;
}

void HelloPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
int HelloPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "hello-player");
...
void HelloPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void HelloPlayer::createViewMenu(void)
{
...
void HelloPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void HelloPlayer::updateWindowTitle(void)
{
}

void HelloPlayer::relaunch(void)
{
...
void HelloPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void HelloPlayer::onFileOpenProject(void)
{
...
void HelloPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"HelloPlayer");
...
void HelloPlayer::onFileProjectConfig(void)
{
...
void HelloPlayer::onFileRelaunch(void)
{
    relaunch();
}

void HelloPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void HelloPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void HelloPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void HelloPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void HelloPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT HelloPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    HelloPlayer *host = HelloPlayer::sharedInstance();
...
INT_PTR CALLBACK HelloPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
